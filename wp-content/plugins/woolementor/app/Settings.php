...
class Settings extends Base {
	...
	public function init_menu() {
		...
		$pro_settings = [
			'id'            => "{$this->slug}-pro",
			'parent'        => $this->slug,
			'label'         => defined( 'CODESIGNER_PRO' ) ? __( 'License', 'codesigner' ) : __( 'Pro Features', 'codesigner' ),
			'title'         => __( 'Pro Features', 'codesigner' ),
			'header'        => __( 'Pro Features', 'codesigner' ),
			'sections'      => [
				'codesigner_upgrade'	=> [
					'id'        => 'codesigner_upgrade',
					'label'     => __( 'Pro Features', 'codesigner' ),
