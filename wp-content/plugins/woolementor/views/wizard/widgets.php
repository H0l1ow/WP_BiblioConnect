...
<div class="wl-content-area">
	<div class="wl-wizard-widget-header">
		<h2><?php echo esc_html__( 'Select the Widget That Suits You Best', 'codesigner' ); ?></h2>
	...
	foreach ( $widget_categories as $_category => $widgets ) {
        ...
        if ( $flag > 0 ) {
            printf( '<div id="wl-dashboard-widgets-%s" class="wl-dashboard-widgets cd-hide-section">', $_category );
        }
        else {
