...
<div class="wl-content-area">
			...
			<div class="wl-group-wrap">
				...
				<div class="wl-header-search">
					<div class="wl-search-area">
						<input id="wl-search" type="text" placeholder="<?php _e( 'Search Modules', 'codesigner' ); ?>">
    ...
    <div class="cd-settings-modules-container">
        ...
        <?php foreach( $modules as $key=>$module ) : ?>
            ...
            <div class="<?php echo 'wl-widget cd-settings-module-block ' . $module_class; ?>">
                <div class="cx-label-wrap">
                    <label for="<?php echo 'codesigner_modules-' . $key; ?>">
                        <?php echo esc_html__( $module['title'], 'codesigner' ); ?>
                    </label>
                    <p class="cd-module-desc"><?php echo $module['desc']; ?></p>
                </div>
                <?php                 
                if ( $module['pro'] ) {
                ...
                <div class="cx-field-wrap">
                    <label class="cx-toggle">
                        <input 
                            ...
                            id="<?php echo 'codesigner_modules-'. $module['id']; ?>" 
...
<div id="wl-pro-popup" style="display: none;">
	...
	<p>
        <a id="wl-pro-popup-btn" href="https://codexpert.io/codesigner/pro/?utm_source=dashboard&utm_medium=settings&utm_campaign=pro-popup" target="_blank">
