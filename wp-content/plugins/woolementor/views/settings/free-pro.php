...
$pro_link	= add_query_arg( $utm, 'https://codexpert.io/codesigner/pro' );
                ...
                foreach( codesigner_widgets() as $key => $widget ) {
                    if( isset( $widget['pro_feature'] ) && $widget['pro_feature'] ) {
                        printf( '<div class="cd-pro-widget">' );
                            printf( '<i class="%1$s"></i>', $widget['icon'] );
                            printf( '<h4>%1$s</h4>', $widget['title'] );
                        printf( '</div>' );
                    }
                }
                ?>
    ...
    <div class="cd-pro-table-control">
        <button class="cd-active" data-id="module">
            <div class="cd-icon-block">
                <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/modules.svg' ); ?>" alt="icon">
            </div>
            <?php esc_html_e( 'Modules', 'codesigner' ); ?>
        </button>
        <button data-id="widget">
            <div class="cd-icon-block">
                <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/widgets.svg' ); ?>" alt="icon">
            </div>
            ...
            <tbody id="cd-pro-table-module">
                <?php 
                    ...
                    foreach( $modules as $key => $module ) {
                        ...
                        printf( '<tr>');
                            printf( '<td class="cd-%2$s-feature">%1$s</td>', $module['title'], $odd_even_text );

                            if ( $module['pro'] ) {
                                printf( '<td class="cd-%2$s-free cd-center"><img src="%1$s" alt="icon"</td>', esc_attr( CODESIGNER_ASSETS . '/img/free-pro/no.svg' ), $odd_even_text );
                            } else {
                                printf( '<td class="cd-%2$s-free cd-center"><img src="%1$s" alt="icon"</td>', esc_attr( CODESIGNER_ASSETS . '/img/free-pro/yes.svg' ), $odd_even_text );
                            }

                            printf( '<td class="cd-%2$s-pro cd-center"><img src="%1$s" alt="icon"</td>', esc_attr( CODESIGNER_ASSETS . '/img/free-pro/yes.svg' ), $odd_even_text );
                        printf( '</tr>' );
                ...
                <?php 
                    ...
                    foreach( codesigner_widgets() as $key => $widget ) {
                        if ( isset( $widget['pro_feature'] ) && $widget['pro_feature'] ) {
                            ...
                            printf( '<tr>');
                                printf( '<td class="cd-%2$s-feature">%1$s</td>', $widget['title'], $odd_even_text );
                                printf( '<td class="cd-%2$s-free cd-center"><img src="%1$s" alt="icon"</td>', esc_attr( CODESIGNER_ASSETS . '/img/free-pro/no.svg' ), $odd_even_text );
                                printf( '<td class="cd-%2$s-pro cd-center"><img src="%1$s" alt="icon"</td>', esc_attr( CODESIGNER_ASSETS . '/img/free-pro/yes.svg' ), $odd_even_text );
                            printf( '</tr>' );
                ...
                <div class="cd-review-user">
                    ...
                    <div class="cd-review-right">
                        <div class="cd-ratings">
                            <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/rating.svg' ); ?>" alt="rating">
                            <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/rating.svg' ); ?>" alt="rating">
                            <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/rating.svg' ); ?>" alt="rating">
                            <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/rating.svg' ); ?>" alt="rating">
                            <img src="<?php echo esc_attr( CODESIGNER_ASSETS . '/img/free-pro/rating.svg' ); ?>" alt="rating">
